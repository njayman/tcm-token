    ...
    return (
      <div>
        ...
        <h1 className="page-header">
          Widget Boxes <small>header small text goes here...</small>
        </h1>
        ...
        <div className="row">
          <div className="col-xl-6">
            ...
            <Panel>
              <PanelHeader noButton={true}>
                <UncontrolledDropdown className="pull-right">
                  ...
                  <DropdownMenu>
                    <DropdownItem>
                      <button type="button" className="btn btn-green-xs">
                        <i className="fa fa-ticket-alt"></i> Add Card
                      </button>
                    </DropdownItem>
                    <DropdownItem>
                      <button type="button" className="btn btn-lime-xs">
                        <i className="far fa-edit"></i> Edit
                      </button>
                    </DropdownItem>
                    <DropdownItem>
                      <button type="button" className="btn btn-orange-xs">
                        <i className="far fa-file-pdf"></i> Save as PDF
                      </button>
                    </DropdownItem>
                    <DropdownItem>
                      <button type="button" className="btn btn-black-xs">
                        <i className="far fa-trash-alt"></i> Delete
                      </button>
                    </DropdownItem>
                    <DropdownItem>
                      <button type="button" className="btn btn-gray-xs">
                        <i className="fas fa-archive"></i> Archive
                      </button>
                    </DropdownItem>
                    <DropdownItem divider />
                    <DropdownItem>
                      <button type="button" className="btn btn-indigo-xs">
                        <i className="ion-md-search"></i> Search in List
                      </button>
                    </DropdownItem>
                  </DropdownMenu>
                </UncontrolledDropdown>
              ...
              <PanelHeader noButton={true}>
                <UncontrolledDropdown className="pull-right">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownItem>
                      <button type="button" className="btn btn-red-xs">
                        <i className="far fa-trash-alt"></i> Delete
                      </button>
                    </DropdownItem>
                    <DropdownItem>
            ...
            <Panel>
              <PanelHeader noButton={true}>
                <span className="label label-success mr-2">NEW</span> Panel
                Header with Label
              </PanelHeader>
              <PanelBody>
                <p>Panel Content Here</p>
            ...
            <Panel>
              <PanelHeader>Panel with Alert Box</PanelHeader>
              <Alert color="success" className="mb-0">
                <i className="fa fa-check fa-2x pull-left m-r-10"></i>
                <p className="m-b-0">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                  Pellentesque ac posuere lacus, quis suscipit sem. Nulla
                  sagittis aliquam erat non convallis.
                </p>
              </Alert>
              <PanelBody>
                <p>Panel Content Here</p>
          ...
          <div className="col-xl-6">
            <Panel className="panel-hover-icon">
              <PanelHeader>Hover View Icon</PanelHeader>
              <PanelBody>
                <p>Panel Content Here</p>
              </PanelBody>
              <CodeMirror
              ...
              <PanelHeader noButton={true}>
                <UncontrolledDropdown className="pull-right">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownItem>
                      <button type="button" className="btn btn-red-xs">
                        <i className="fas fa-compress"></i> Minimize
                      </button>
                    </DropdownItem>
                    <DropdownItem>
                      <button type="button" className="btn btn-red-xs">
              ...
              <PanelBody>
                ...
                >
                  <p>
                    ...
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Pellentesque sed enim arcu. Ut posuere in ligula quis
                    ultricies. In in justo turpis. Donec ut dui at massa gravida
                    interdum nec vitae justo. Quisque ullamcorper vehicula
                    dictum. Nullam hendrerit interdum eleifend. Aenean luctus
                    sed arcu laoreet scelerisque. Vivamus non ullamcorper
                    mauris, id sagittis lorem. Proin tincidunt mauris et dolor
                    mattis imperdiet. Sed facilisis mattis diam elementum
                    adipiscing.
                  </p>
                  <p>
                    ...
                    nostra, per inceptos himenaeos. Ut ante velit, pretium non
                    nisi a, egestas placerat diam. Nullam aliquet iaculis
                    ultricies. Aliquam volutpat, sapien quis volutpat elementum,
                    ligula purus auctor diam, at vestibulum nulla augue vel
                    purus. Praesent ac nisl a magna tincidunt interdum sed in
                    turpis. Maecenas nec condimentum risus. In congue pretium
                  ...
                  <p>
                    ...
                    Praesent eu ultrices justo. Vestibulum ante ipsum primis in
                    faucibus orci luctus et ultrices posuere cubilia Curae; Cras
                    mattis ipsum quis sapien consectetur fringilla. Etiam
                    sagittis sem tempus purus elementum, vitae pretium sapien
                    porta. Curabitur iaculis ante ut aliquam luctus. Vivamus
                    ullamcorper blandit imperdiet. Ut egestas, orci id rhoncus
                    cursus, orci risus scelerisque enim, eget mattis eros lacus
                    quis ligula. Vivamus ullamcorper urna eget hendrerit
                    laoreet.
                  </p>
                  <p>
                    <span className="fa-stack fa-4x pull-right m-l-10 text-inverse">
                    ...
                    malesuada fames ac turpis egestas. Morbi accumsan velit
                    dolor. Donec convallis eleifend magna, at euismod tellus
                    convallis a. Curabitur in nisi dolor. Cras viverra
                    scelerisque orci, sed interdum ligula volutpat non. Nunc eu
                    enim ac neque tempor feugiat. Duis posuere lacus non magna
                    eleifend, non dictum sem feugiat. Duis eleifend condimentum
                    pulvinar.
                  </p>
                </PerfectScrollbar>
              </PanelBody>
            ...
            <Panel>
              <PanelHeader>Panel with Toolbar & Footer</PanelHeader>
              ...
              <textarea
                className="form-control no-rounded-corner"
                rows="5"
                defaultValue="This is a form textarea."
              ></textarea>
        ...
        <p className="m-b-20">
          You can customize the panel body / header <code>background</code> &{" "}
          <code>text color</code> by adding predefined CSS class. E.g{" "}
          <code>.bg-black</code>. Full list of available predefined background
          class can be found <a href="helper_css.html">here</a>.
        </p>
