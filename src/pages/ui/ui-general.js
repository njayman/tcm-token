      ...
      <div>
        ...
        <div className="row">
          <div className="col-xl-6">
            <Panel>
              ...
              <PanelBody>
                ...
                >
                  ...
                  <Link to="/ui/general" className="alert-link">
                    an example link
                  </Link>
                  .
                </Alert>
            ...
            <Panel>
              <PanelHeader>
                Alerts Color <span className="label label-success">NEW</span>
              </PanelHeader>
              <PanelBody>
                ...
                <div className="note note-primary m-b-15">
                  ...
                  <div className="note-content">
                    ...
                    <p>
                      ...
                      Maecenas id gravida libero. Etiam semper id sem a
                      ultricies.
                    </p>
                  </div>
                </div>
                ...
                <div className="row f-s-15">
                  <div className="col-md-8">
                    ...
                    <div className="m-b-3">
                      ...
                      <span className="label label-secondary m-r-3">
                        Secondary
                      </span>
            ...
            <Panel>
              ...
              <PanelBody>
                ...
                <ul className="pager m-b-10">
                  <li>
                    <Link to="/ui/general">Previous</Link>
                  </li>
                  <li>
                    <Link to="/ui/general">Next</Link>
                  </li>
                </ul>
                <ul className="pager m-t-0 m-b-0">
                  <li className="previous disabled">
                    <Link to="/ui/general">&larr; Older</Link>
                  </li>
                  <li className="next">
                    <Link to="/ui/general">Newer &rarr;</Link>
                  </li>
                </ul>
              </PanelBody>
              <CodeMirror
